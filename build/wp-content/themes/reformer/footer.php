		...
		<div class="container">
			...
			<div class="row">
				<div class="footer-logos">
					...
					<div class="sponsors">
	        	<div class="lcef-logo-white"><a href="http://lcef.org/" title="Lutheran Church Extension Fund" target="_blank"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/lcef-logo-white.png" alt="LutheranReformation.org Sponsor - Lutheran Church Extension Fund"></a></a></div>
				...
				© 2015-<?php echo date('Y'); ?> The Lutheran Church—Missouri Synod. All rights reserved.
				</div>
...
<?php if(is_front_page()) : ?>
	<script src="https://cph.org/images/topics/images/topicpages/littleluther/js/jquery.plugin.js"></script>
	<script src="https://cph.org/images/topics/images/topicpages/littleluther/js/jquery.countdown.js"></script>
	<script>
	jQuery(function () {
